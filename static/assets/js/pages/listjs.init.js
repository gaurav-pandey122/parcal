        ...
        a.addEventListener("submit", function (e) {
            ...
            a.checkValidity() ? (e.preventDefault(), "" === customerNameField.value || "" === emailField.value || "" === dateField.value || "" === phoneField.value || editlist ? "" !== customerNameField.value && "" !== emailField.value && "" !== dateField.value && "" !== phoneField.value && editlist && (t = customerList.get({id: idField.value}), Array.from(t).forEach(function (e) {
                (isid = (new DOMParser).parseFromString(e._values.id, "text/html")).body.firstElementChild.innerHTML == itemId && e.values({
                    ...
                    email: emcustomerTableailField.value,
        ...
        e.addEventListener("click", function (e) {
            ...
            Array.from(e).forEach(function (e) {
                ...
                t == itemId && (editlist = !0, idField.value = t, customerNameField.value = e._values.customer_name, emailField.value = e._values.email, dateField.value = e._values.date, phoneField.value = e._values.phone, statusVal && statusVal.destroy(), statusVal = new Choices(statusField), t = (val = (new DOMParser).parseFromString(e._values.status, "text/html")).body.firstElementChild.innerHTML, statusVal.setChoiceByValue(t), flatpickr("#date-field", {
                    dateFormat: "d M, Y", defaultDate: e._values.date
                }))
            })
        })
    })
...
var attroptions = {
        ...
        name: "Leia", born: "1954", image: "assets/images/users/avatar-5.jpg", id: 5, timestamp: "67893"
